...
The player use css variables to stylized some parts of the app, but the player is still totally customisable throught overload of the css class.

#### CSS variables available are theirs default presets:
