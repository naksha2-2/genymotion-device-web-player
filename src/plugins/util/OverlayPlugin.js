...
class OverlayPlugin {
     ...
     *
     * @param {string|null} [title=null] - The title of the modal. If null, no title will be set.
     * @param {string} [classes=''] - Additional classes to add to the modal container.
     ...
     */
    createTemplateModal(title = '', classes = '') {
